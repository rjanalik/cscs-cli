...
impl PasswordManager for KeePassXC {
    fn get_credentials(&self, pass_service: String, username: String) -> anyhow::Result<Credentials> {
        debug!("Getting credentials from keepassxc: service {}, username {}", pass_service, username);
        ...
        // Get password
        let mut password_command = Command::new("keepassxc-cli");
